...
import LiftOrphans ()
{-# LINE 13 "src-generated/SemHsTokens.hs" #-}
...
{-# LINE 25 "src-generated/SemHsTokens.hs" #-}
...
{-# LINE 32 "src-generated/SemHsTokens.hs" #-}
-- HsToken -----------------------------------------------------
-- wrapper
...
sem_HsToken_AGLocal arg_var_ arg_pos_ arg_rdesc_ = T_HsToken (return st2) where
   ...
   rule2 = \ ((_lhsIallfields) :: [(Identifier,Type,ChildKind)]) ((_lhsIallnts) :: [Identifier]) ((_lhsIattrs) :: [(Identifier,Identifier)]) ((_lhsIcon) :: Identifier) ((_lhsIfieldnames) :: [Identifier]) ((_lhsInt) :: Identifier) ((_lhsIoptions) :: Options) _tkAsField _tkAsLocal pos_ var_ ->
                       ...
                       {-# LINE 116 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule3 #-}
   ...
   rule3 = \ ((_lhsIfieldnames) :: [Identifier]) var_ ->
                               ...
                               {-# LINE 124 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule4 #-}
   rule4 = \ _errors ->
     _errors
   {-# INLINE rule5 #-}
...
sem_HsToken_AGField arg_field_ arg_attr_ arg_pos_ arg_rdesc_ = T_HsToken (return st2) where
   ...
   rule9 = \ ((_lhsIattrs) :: [(Identifier,Identifier)]) ((_lhsIcon) :: Identifier) ((_lhsIfieldnames) :: [Identifier]) ((_lhsInt) :: Identifier) attr_ field_ ->
                             ...
                             {-# LINE 172 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule10 #-}
   ...
   rule10 = \ attr_ field_ ->
                  ...
                  {-# LINE 180 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule11 #-}
   ...
   rule11 = \ attr_ field_ rdesc_ ->
                        ...
                        case rdesc_ of
                          ...
                          Nothing -> id
                        {-# LINE 188 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule12 #-}
   ...
   rule12 = \ _addTrace ((_lhsIoptions) :: Options) attr_ field_ pos_ ->
                   ...
                   {-# LINE 194 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule13 #-}
   rule13 = \  (_ :: ()) ->
     Seq.empty
   {-# INLINE rule14 #-}
...
sem_HsToken_HsToken arg_value_ arg_pos_ = T_HsToken (return st2) where
   ...
   rule16 = \ pos_ value_ ->
                         {-# LINE 128 "src-ag/SemHsTokens.ag" #-}
                         (pos_, value_)
                         {-# LINE 232 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule17 #-}
   rule17 = \  (_ :: ()) ->
     Seq.empty
   {-# INLINE rule18 #-}
...
sem_HsToken_CharToken arg_value_ arg_pos_ = T_HsToken (return st2) where
   ...
   rule23 = \ pos_ value_ ->
                           ...
                           {-# LINE 282 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule24 #-}
   rule24 = \  (_ :: ()) ->
     Seq.empty
   {-# INLINE rule25 #-}
...
sem_HsToken_StrToken arg_value_ arg_pos_ = T_HsToken (return st2) where
   ...
   rule30 = \ pos_ value_ ->
                           ...
                           {-# LINE 329 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule31 #-}
   rule31 = \  (_ :: ()) ->
     Seq.empty
   {-# INLINE rule32 #-}
...
sem_HsToken_Err arg_mesg_ arg_pos_ = T_HsToken (return st2) where
   ...
   rule37 = \ mesg_ pos_ ->
                       ...
                       {-# LINE 377 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule38 #-}
   {-# LINE 136 "src-ag/SemHsTokens.ag" #-}
   rule38 = \ pos_ ->
                           {-# LINE 136 "src-ag/SemHsTokens.ag" #-}
                           (pos_, "")
                           {-# LINE 383 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule39 #-}
   rule39 = \  (_ :: ()) ->
     []
   {-# INLINE rule40 #-}
...
sem_HsTokens_Cons arg_hd_ arg_tl_ = T_HsTokens (return st5) where
   ...
   rule44 = \ ((_hdItok) :: (Pos,String)) ((_tlItks) :: [(Pos,String)]) ->
                     {-# LINE 118 "src-ag/SemHsTokens.ag" #-}
                     _hdItok : _tlItks
                     {-# LINE 476 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule45 #-}
...
sem_HsTokens_Nil  = T_HsTokens (return st5) where
   ...
   rule65 = \  (_ :: ()) ->
                     {-# LINE 119 "src-ag/SemHsTokens.ag" #-}
                     []
                     {-# LINE 565 "src-generated/SemHsTokens.hs" #-}
   {-# INLINE rule66 #-}
   rule66 = \  (_ :: ()) ->
     Seq.empty
   {-# INLINE rule67 #-}
