...
import LiftOrphans ()
{-# LINE 17 "src-generated/ExecutionPlan2Caml.hs" #-}
...
import Language.Haskell.TH.Syntax (Lift)
import LiftOrphans ()
{-# LINE 25 "src-generated/ExecutionPlan2Caml.hs" #-}
...
import Language.Haskell.TH.Syntax (Lift)
import LiftOrphans ()
{-# LINE 34 "src-generated/ExecutionPlan2Caml.hs" #-}
...
import Data.Map(Map)
{-# LINE 48 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 76 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 102 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 124 "src-generated/ExecutionPlan2Caml.hs" #-}
...
orderStates initial edges = res where
  ...
  res = flattenSCCs cps
{-# LINE 190 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 200 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 218 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 230 "src-generated/ExecutionPlan2Caml.hs" #-}
...
nextStName :: String
nextStName = "__st_"
{-# LINE 239 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 249 "src-generated/ExecutionPlan2Caml.hs" #-}
...
dummyType opts noArgs
  | not noArgs            = empty
  | otherwise             = text "unit"
{-# LINE 268 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 301 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 315 "src-generated/ExecutionPlan2Caml.hs" #-}

{-# LINE 1229 "src-ag/ExecutionPlan2Caml.ag" #-}

unionWithSum = Map.unionWith (+)
{-# LINE 320 "src-generated/ExecutionPlan2Caml.hs" #-}
...
{-# LINE 329 "src-generated/ExecutionPlan2Caml.hs" #-}
-- EChild ------------------------------------------------------
-- wrapper
...
sem_EChild_EChild arg_name_ arg_tp_ arg_kind_ arg_hasAround_ _ _ = T_EChild (return st2) where
   ...
   rule0 = \ tp_ ->
                         ...
                         {-# LINE 397 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule1 #-}
   {-# LINE 279 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule1 = \ tp_ ->
                         {-# LINE 279 "src-ag/ExecutionPlan2Caml.ag" #-}
                         ppTp $ forceDeforested tp_
                         {-# LINE 403 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule2 #-}
   ...
   rule2 = \ ((_lhsIcon) :: ConstructorIdent) ((_lhsInt) :: NontermIdent) name_ ->
                         ...
                         {-# LINE 409 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule3 #-}
   {-# LINE 281 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule3 = \ name_ ->
                         {-# LINE 281 "src-ag/ExecutionPlan2Caml.ag" #-}
                         text (fieldname name_)
                         {-# LINE 415 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule4 #-}
   ...
   rule4 = \ _childNm _fieldNm _tpDocDefor _tpDocFor ->
                     ...
                     {-# LINE 421 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule5 #-}
   ...
   rule5 = \ _field kind_ ->
                         ...
                         case kind_ of
                           ChildAttr -> []
                           _         -> [_field    ]
                         {-# LINE 429 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule6 #-}
   ...
   rule8 = \ tp_ ->
                               ...
                               case tp_ of
                                 NT _ _ defor -> defor
                                 _            -> False
                               {-# LINE 452 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule9 #-}
   ...
   rule9 = \ _isDefor ((_lhsIoptions) :: Options) _nt kind_ name_ ->
                               ...
                               {-# LINE 467 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule10 #-}
   ...
   rule10 = \ ((_lhsIoptions) :: Options) hasAround_ name_ ->
                               ...
                               {-# LINE 475 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule11 #-}
   ...
   rule11 = \ _aroundcode _initSt _isDefor ((_lhsIoptions) :: Options) _nt _valcode hasAround_ kind_ name_ ->
                               ...
                               {-# LINE 500 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule12 #-}
   {-# LINE 961 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule12 = \ tp_ ->
                      {-# LINE 961 "src-ag/ExecutionPlan2Caml.ag" #-}
                      extractNonterminal tp_
                      {-# LINE 506 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule13 #-}
   {-# LINE 1424 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule13 = \ name_ tp_ ->
                     {-# LINE 1424 "src-ag/ExecutionPlan2Caml.ag" #-}
                     Map.singleton name_ tp_
                     {-# LINE 512 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule14 #-}
   ...
   rule14 = \ ((_lhsIallInitStates) :: Map NontermIdent Int) _nt ->
                 ...
                 {-# LINE 518 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule15 #-}
   rule15 = \  (_ :: ()) ->
     Set.empty
...
sem_EChild_ETerm arg_name_ arg_tp_ = T_EChild (return st2) where
   ...
   rule16 = \ tp_ ->
                         {-# LINE 278 "src-ag/ExecutionPlan2Caml.ag" #-}
                         ppTp $ removeDeforested tp_
                         {-# LINE 552 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule17 #-}
   {-# LINE 279 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule17 = \ tp_ ->
                         {-# LINE 279 "src-ag/ExecutionPlan2Caml.ag" #-}
                         ppTp $ forceDeforested tp_
                         {-# LINE 558 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule18 #-}
   {-# LINE 280 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule18 = \ ((_lhsIcon) :: ConstructorIdent) ((_lhsInt) :: NontermIdent) name_ ->
                         {-# LINE 280 "src-ag/ExecutionPlan2Caml.ag" #-}
                         text $ recordFieldname _lhsInt _lhsIcon name_
                         {-# LINE 564 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule19 #-}
   {-# LINE 281 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule19 = \ name_ ->
                         {-# LINE 281 "src-ag/ExecutionPlan2Caml.ag" #-}
                         text (fieldname name_)
                         {-# LINE 570 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule20 #-}
   {-# LINE 282 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule20 = \ _childNm _fieldNm _tpDocDefor _tpDocFor ->
                     {-# LINE 282 "src-ag/ExecutionPlan2Caml.ag" #-}
                     (_fieldNm    , _childNm    , _tpDocDefor    , _tpDocFor    )
                     {-# LINE 576 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule21 #-}
   {-# LINE 286 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule21 = \ _field ->
                         {-# LINE 286 "src-ag/ExecutionPlan2Caml.ag" #-}
                         [_field    ]
                         {-# LINE 582 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule22 #-}
   {-# LINE 400 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule22 = \ name_ ->
                             {-# LINE 400 "src-ag/ExecutionPlan2Caml.ag" #-}
                             text $ fieldname name_
                             {-# LINE 588 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule23 #-}
   {-# LINE 922 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule23 = \ name_ ->
                               {-# LINE 922 "src-ag/ExecutionPlan2Caml.ag" #-}
                               Map.singleton name_ (\_ -> Right (empty, Set.empty, Map.empty))
                               {-# LINE 594 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule24 #-}
   {-# LINE 1266 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule24 = \ name_ ->
                       {-# LINE 1266 "src-ag/ExecutionPlan2Caml.ag" #-}
                       Set.singleton $ fieldname name_
                       {-# LINE 600 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule25 #-}
   {-# LINE 1424 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule25 = \ name_ tp_ ->
                     {-# LINE 1424 "src-ag/ExecutionPlan2Caml.ag" #-}
                     Map.singleton name_ tp_
                     {-# LINE 606 "src-generated/ExecutionPlan2Caml.hs" #-}
...
sem_ENonterminal_ENonterminal arg_nt_ arg_params_ _ arg_initial_ arg_initialv_ arg_nextVisits_ arg_prevVisits_ arg_prods_ _ _ = T_ENonterminal (return st8) where
   ...
   rule48 = \ ((_lhsIoptions) :: Options) ->
                   {-# LINE 78 "src-ag/ExecutionPlan2Caml.ag" #-}
                   rename _lhsIoptions
                   {-# LINE 901 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule49 #-}
   {-# LINE 86 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule49 = \ nt_ ->
               {-# LINE 86 "src-ag/ExecutionPlan2Caml.ag" #-}
               nt_
               {-# LINE 907 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule50 #-}
   {-# LINE 96 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule50 = \ params_ ->
                   {-# LINE 96 "src-ag/ExecutionPlan2Caml.ag" #-}
                   params_
                   {-# LINE 913 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule51 #-}
   ...
   rule51 = \ _c_states _datatypeNt _datatypeProds _hasWrapper ((_lhsIoptions) :: Options) ((_prodsIt_visits) :: PP_Doc) _t_init _t_states _wr_inh _wr_syn nt_ ->
                ...
                {-# LINE 940 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule52 #-}
   ...
   rule58 = \ _aliasMod _aliasPre ((_lhsItypeSyns) :: TypeSyns) ((_prodsIdatatype) :: [PP_Doc]) ((_prodsIdatatype_call) :: [PP_Doc]) _t_params nt_ ->
        ...
        {-# LINE 1014 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule59 #-}
   ...
   rule59 = \ ((_lhsItypeSyns) :: TypeSyns) ((_prodsIdatatype_con) :: [PP_Doc]) nt_ ->
        ...
        {-# LINE 1022 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule60 #-}
   ...
   rule79 = \ _t_params _t_type initial_ nt_ ->
                    ...
                    {-# LINE 1182 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule80 #-}
   ...
   rule80 = \ _allstates _t_c_params _t_params nextVisits_ nt_ ->
                    ...
                    {-# LINE 1197 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule81 #-}
   ...
   rule84 = \ _t_params nt_ ->
                   ...
                   {-# LINE 1236 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule85 #-}
   ...
   rule88 = \ ((_lhsIoptions) :: Options) ->
                    ...
                    {-# LINE 1262 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule89 #-}
   ...
   rule96 = \ ((_lhsIoptions) :: Options) _wr_inhs1 nt_ ->
                       ...
                       {-# LINE 1310 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule97 #-}
   {-# LINE 610 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule97 = \ _synname _t_params ->
                    {-# LINE 610 "src-ag/ExecutionPlan2Caml.ag" #-}
                    _t_params     >#< _synname
                    {-# LINE 1316 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule98 #-}
   ...
   rule98 = \ _o_sigs _wrapArgInhTp _wrapArgPats _wrapArgSemTp _wrapResTp _wrapname _wrapperPreamble ->
                   ...
                   {-# LINE 1322 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule99 #-}
   ...
   rule99 = \ ((_lhsImainName) :: String) ((_lhsIoptions) :: Options) _wrapperBody ->
        ...
        >-< _wrapperBody
        {-# LINE 1332 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule100 #-}
   ...
   rule100 = \ _firstVisitInfo ((_lhsIoptions) :: Options) _wr_inhs _wr_syns initial_ initialv_ nt_ ->
        ...
        {-# LINE 1355 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule101 #-}
   ...
   rule101 = \ ((_prodsIsemFunBndDefs) :: Seq PP_Doc) _semFunBndDef ->
                        ...
                        {-# LINE 1361 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule102 #-}
   ...
   rule102 = \ ((_prodsIsemFunBndTps) :: Seq PP_Doc) _semFunBndTp ->
                        ...
                        {-# LINE 1367 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule103 #-}
   {-# LINE 650 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule103 = \ _semFunBndNm _semname ->
                        {-# LINE 650 "src-ag/ExecutionPlan2Caml.ag" #-}
                        _semFunBndNm     >#< "=" >#< _semname
                        {-# LINE 1373 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule104 #-}
   {-# LINE 651 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule104 = \ _semFunBndNm _sem_tp ->
                        {-# LINE 651 "src-ag/ExecutionPlan2Caml.ag" #-}
                        _semFunBndNm     >#< ":" >#< _sem_tp
                        {-# LINE 1379 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule105 #-}
   {-# LINE 652 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule105 = \ nt_ ->
                        {-# LINE 652 "src-ag/ExecutionPlan2Caml.ag" #-}
                        lateSemNtLabel nt_
                        {-# LINE 1385 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule106 #-}
   {-# LINE 682 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule106 = \ initial_ ->
                      {-# LINE 682 "src-ag/ExecutionPlan2Caml.ag" #-}
                      initial_
                      {-# LINE 1391 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule107 #-}
   {-# LINE 683 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule107 = \ _allstates ->
                      {-# LINE 683 "src-ag/ExecutionPlan2Caml.ag" #-}
                      _allstates
                      {-# LINE 1397 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule108 #-}
   {-# LINE 1390 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule108 = \ nextVisits_ ->
                       {-# LINE 1390 "src-ag/ExecutionPlan2Caml.ag" #-}
                       nextVisits_
                       {-# LINE 1403 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule109 #-}
   {-# LINE 1391 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule109 = \ prevVisits_ ->
                       {-# LINE 1391 "src-ag/ExecutionPlan2Caml.ag" #-}
                       prevVisits_
                       {-# LINE 1409 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule110 #-}
...
sem_EProduction_EProduction arg_con_ arg_params_ _ arg_rules_ arg_children_ arg_visits_ = T_EProduction (return st14) where
   ...
   rule191 = \ ((_childrenIsigs) :: [(PP_Doc,PP_Doc,PP_Doc,PP_Doc)]) _conname ((_lhsInt) :: NontermIdent) _o_records _o_sigs _t_params con_ ->
        ...
        in decl
        {-# LINE 1980 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule192 #-}
   {-# LINE 384 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule192 = \  (_ :: ()) ->
                                              {-# LINE 384 "src-ag/ExecutionPlan2Caml.ag" #-}
                                              1
                                              {-# LINE 1986 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule193 #-}
   ...
   rule201 = \ ((_lhsInt) :: NontermIdent) ((_lhsIoptions) :: Options) con_ ->
                     ...
                     {-# LINE 2041 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule202 #-}
   {-# LINE 689 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule202 = \ _t_params _t_type ->
                     {-# LINE 689 "src-ag/ExecutionPlan2Caml.ag" #-}
                     _t_params     >#< _t_type
                     {-# LINE 2047 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule203 #-}
   ...
   rule203 = \ ((_childrenIsigs) :: [(PP_Doc,PP_Doc,PP_Doc,PP_Doc)]) _sem_res_tp ->
                     ...
                     {-# LINE 2053 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule204 #-}
   {-# LINE 693 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule204 = \  (_ :: ()) ->
        {-# LINE 693 "src-ag/ExecutionPlan2Caml.ag" #-}
        empty
        {-# LINE 2059 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule205 #-}
   ...
   rule205 = \ ((_childrenIsigs) :: [(PP_Doc,PP_Doc,PP_Doc,PP_Doc)]) _o_sigs _prod_body _sem_res_tp _semname ->
                    ...
                    {-# LINE 2065 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule206 #-}
   ...
   rule208 = \ ((_lhsIinitial) :: StateIdentifier) ((_lhsInextVisits) :: Map StateIdentifier StateCtx) ((_lhsInt) :: NontermIdent) _stargs _stks _stvs ->
        ...
        {-# LINE 2102 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule209 #-}
   ...
   rule222 = \ ((_childrenIchildTypes) :: Map Identifier Type) ((_lhsIntType) :: Type) ->
                     ...
                     {-# LINE 2214 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule223 #-}
   ...
   rule223 = \ ((_lhsIlocalAttrTypes) :: Map ConstructorIdent (Map Identifier Type)) con_ ->
                           ...
                           {-# LINE 2220 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule224 #-}
...
sem_EProductions_Cons arg_hd_ arg_tl_ = T_EProductions (return st17) where
   ...
   rule265 = \ ((_hdIallvisits) :: [VisitStateState]) ->
                           {-# LINE 439 "src-ag/ExecutionPlan2Caml.ag" #-}
                           _hdIallvisits
                           {-# LINE 2470 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule266 #-}
   {-# LINE 534 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule266 = \ ((_hdIt_visits) :: PP_Doc) ->
                   {-# LINE 534 "src-ag/ExecutionPlan2Caml.ag" #-}
                   _hdIt_visits
                   {-# LINE 2476 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule267 #-}
...
sem_EProductions_Nil  = T_EProductions (return st17) where
   ...
   rule325 = \  (_ :: ()) ->
                           ...
                           {-# LINE 2698 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule326 #-}
   rule326 = \  (_ :: ()) ->
     Map.empty
   {-# INLINE rule327 #-}
...
sem_ERule_ERule arg_name_ arg_pattern_ arg_rhs_ _ _ arg_explicit_ arg_pure_ arg_mbError_ = T_ERule (return st20) where
   ...
   rule341 = \ _rulecode _used ->
                          ...
                          {-# LINE 2826 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule342 #-}
   ...
   rule342 = \ _declHead _endpragma _genpragma _pragma ((_rhsIpos) :: Pos) ((_rhsIsemfunc) :: PP_Doc) ->
                          ...
                          >#< "in"
                          {-# LINE 2842 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule343 #-}
   ...
   rule343 = \ ((_lhsIoptions) :: Options) ((_rhsIpos) :: Pos) ->
                           ...
                           {-# LINE 2848 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule344 #-}
   ...
   rule344 = \ ((_lhsImainFile) :: String) ((_lhsIoptions) :: Options) ->
                           ...
                           {-# LINE 2854 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule345 #-}
   ...
   rule347 = \ _argPats ((_lhsIoptions) :: Options) ((_rhsIattrs) :: Map String (Maybe NonLocalAttr)) name_ ->
                       ...
                       {-# LINE 2872 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule348 #-}
   ...
   rule348 = \ ((_lhsIallInhmap) :: Map NontermIdent Attributes) ((_lhsIallSynmap) :: Map NontermIdent Attributes) ((_lhsIchildTypes) :: Map Identifier Type) ((_lhsIlocalAttrTypes) :: Map Identifier Type) ((_lhsIoptions) :: Options) ((_rhsIattrs) :: Map String (Maybe NonLocalAttr)) ->
            ...
            {-# LINE 2890 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule349 #-}
   ...
   rule350 = \ _argExprs ((_lhsIoptions) :: Options) ((_patternIextraDefs) :: [(PP_Doc,PP_Doc)]) ((_patternIsem_lhs) ::  PP_Doc ) ((_rhsIattrs) :: Map String (Maybe NonLocalAttr)) name_ pure_ ->
                       ...
                       {-# LINE 2907 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule351 #-}
   {-# LINE 1024 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule351 = \ _stepcode name_ ->
                       {-# LINE 1024 "src-ag/ExecutionPlan2Caml.ag" #-}
                       Map.singleton name_ _stepcode
                       {-# LINE 2913 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule352 #-}
   ...
   rule352 = \ ((_lhsIusageInfo) :: Map Identifier Int) name_ ->
                                                 ...
                                                 {-# LINE 2919 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule353 #-}
   ...
   rule356 = \ ((_rhsIattrs) :: Map String (Maybe NonLocalAttr)) name_ ->
                           ...
                           {-# LINE 2943 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule357 #-}
   ...
   rule357 = \ _used mbError_ ->
                 ...
                 case mbError_ of
                   ...
                   _                      -> Seq.empty
                 {-# LINE 2951 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule358 #-}
...
sem_ExecutionPlan_ExecutionPlan arg_nonts_ arg_typeSyns_ arg_wrappers_ _ = T_ExecutionPlan (return st26) where
   ...
   rule404 = \ ((_nontsIcode) :: PP_Doc) _wrappersExtra ->
                 ...
                 {-# LINE 3267 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule405 #-}
   {-# LINE 106 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule405 = \ _commonExtra ((_nontsIdatas) :: PP_Doc) ->
                 {-# LINE 106 "src-ag/ExecutionPlan2Caml.ag" #-}
                 _nontsIdatas >-< _commonExtra
                 {-# LINE 3273 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule406 #-}
   {-# LINE 112 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule406 = \ wrappers_ ->
                     {-# LINE 112 "src-ag/ExecutionPlan2Caml.ag" #-}
                     wrappers_
                     {-# LINE 3279 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule407 #-}
   {-# LINE 173 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule407 = \ typeSyns_ ->
                     {-# LINE 173 "src-ag/ExecutionPlan2Caml.ag" #-}
                     typeSyns_
                     {-# LINE 3285 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule408 #-}
   ...
   rule408 = \ _lateSemBndDef ((_lhsIoptions) :: Options) ->
                        ...
                        {-# LINE 3293 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule409 #-}
   ...
   rule409 = \ _lateSemBndTp ((_lhsIoptions) :: Options) ->
                        ...
                        {-# LINE 3301 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule410 #-}
   ...
   rule410 = \ ((_lhsImainName) :: String) ((_nontsIsemFunBndTps) :: Seq PP_Doc) ->
                       ...
                       {-# LINE 3307 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule411 #-}
   ...
   rule411 = \ ((_lhsImainName) :: String) ((_nontsIsemFunBndDefs) :: Seq PP_Doc) ->
                        ...
                        {-# LINE 3314 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule412 #-}
...
sem_Expression_Expression arg_pos_ arg_tks_ = T_Expression (return st29) where
   ...
   rule426 = \ tks_ ->
                           {-# LINE 1028 "src-ag/ExecutionPlan2Caml.ag" #-}
                           tks_
                           {-# LINE 3430 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule427 #-}
   {-# LINE 1049 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule427 = \ pos_ ->
                                        {-# LINE 1049 "src-ag/ExecutionPlan2Caml.ag" #-}
                                        pos_
                                        {-# LINE 3436 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule428 #-}
   ...
   rule428 = \ _inhhstoken tks_ ->
                               ...
                               {-# LINE 3442 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule429 #-}
   ...
   rule429 = \ _inhhstoken tks_ ->
                               ...
                               {-# LINE 3448 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule430 #-}
   {-# LINE 1143 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule430 = \ ((_lhsIoptions) :: Options) ->
                                  {-# LINE 1143 "src-ag/ExecutionPlan2Caml.ag" #-}
                                  Inh_HsToken _lhsIoptions
                                  {-# LINE 3454 "src-generated/ExecutionPlan2Caml.hs" #-}
...
sem_HsToken_AGLocal arg_var_ arg_pos_ _ = T_HsToken (return st32) where
   ...
   rule431 = \ var_ ->
                              ...
                              {-# LINE 3511 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule432 #-}
   {-# LINE 1363 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule432 = \ pos_ var_ ->
                          {-# LINE 1363 "src-ag/ExecutionPlan2Caml.ag" #-}
                          (pos_,fieldname var_)
                          {-# LINE 3517 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule433 #-}
   rule433 = \ _tok ->
     _tok
...
sem_HsToken_AGField arg_field_ arg_attr_ arg_pos_ arg_rdesc_ = T_HsToken (return st32) where
   ...
   rule434 = \ attr_ field_ ->
                              ...
                              {-# LINE 3544 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule435 #-}
   ...
   rule435 = \ ((_lhsIoptions) :: Options) _mbAttr attr_ field_ ->
                              ...
                              {-# LINE 3550 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule436 #-}
   ...
   rule436 = \ attr_ field_ rdesc_ ->
                        ...
                        case rdesc_ of
                          ...
                          Nothing -> id
                        {-# LINE 3558 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule437 #-}
   ...
   rule437 = \ _addTrace ((_lhsIoptions) :: Options) attr_ field_ pos_ ->
                   ...
                   {-# LINE 3564 "src-generated/ExecutionPlan2Caml.hs" #-}
...
sem_HsToken_HsToken arg_value_ arg_pos_ = T_HsToken (return st32) where
   ...
   rule438 = \ pos_ value_ ->
                         {-# LINE 1372 "src-ag/ExecutionPlan2Caml.ag" #-}
                         (pos_, value_)
                         {-# LINE 3584 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule439 #-}
   rule439 = \  (_ :: ()) ->
     Map.empty
...
sem_HsToken_CharToken arg_value_ arg_pos_ = T_HsToken (return st32) where
   ...
   rule440 = \ pos_ value_ ->
                           ...
                           {-# LINE 3610 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule441 #-}
   rule441 = \  (_ :: ()) ->
     Map.empty
...
sem_HsToken_StrToken arg_value_ arg_pos_ = T_HsToken (return st32) where
   ...
   rule442 = \ pos_ value_ ->
                           ...
                           {-# LINE 3633 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule443 #-}
   rule443 = \  (_ :: ()) ->
     Map.empty
...
sem_HsToken_Err _ arg_pos_ = T_HsToken (return st32) where
   ...
   rule444 = \ pos_ ->
                           {-# LINE 1380 "src-ag/ExecutionPlan2Caml.ag" #-}
                           (pos_, "")
                           {-# LINE 3656 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule445 #-}
   rule445 = \  (_ :: ()) ->
     Map.empty
...
sem_HsTokens_Cons arg_hd_ arg_tl_ = T_HsTokens (return st35) where
   ...
   rule446 = \ ((_hdItok) :: (Pos,String)) ((_tlItks) :: [(Pos,String)]) ->
                     {-# LINE 1359 "src-ag/ExecutionPlan2Caml.ag" #-}
                     _hdItok : _tlItks
                     {-# LINE 3714 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule447 #-}
...
sem_HsTokens_Nil  = T_HsTokens (return st35) where
   ...
   rule449 = \  (_ :: ()) ->
                     {-# LINE 1360 "src-ag/ExecutionPlan2Caml.ag" #-}
                     []
                     {-# LINE 3738 "src-generated/ExecutionPlan2Caml.hs" #-}
...
sem_Pattern_Constr arg_name_ arg_pats_ = T_Pattern (return st41) where
   ...
   rule451 = \ ((_patsIsem_lhs) :: [PP_Doc]) name_ ->
                                  ...
                                  {-# LINE 3858 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule452 #-}
   {-# LINE 1075 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule452 = \  (_ :: ()) ->
                                    {-# LINE 1075 "src-ag/ExecutionPlan2Caml.ag" #-}
                                    False
                                    {-# LINE 3864 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule453 #-}
...
sem_Pattern_Product arg_pos_ arg_pats_ = T_Pattern (return st41) where
   ...
   rule465 = \ ((_patsIsem_lhs) :: [PP_Doc]) ->
                                  ...
                                  {-# LINE 3938 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule466 #-}
   {-# LINE 1076 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule466 = \  (_ :: ()) ->
                                    {-# LINE 1076 "src-ag/ExecutionPlan2Caml.ag" #-}
                                    False
                                    {-# LINE 3944 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule467 #-}
...
sem_Pattern_Alias arg_field_ arg_attr_ arg_pat_ = T_Pattern (return st41) where
   ...
   rule479 = \ ((_lhsIoptions) :: Options) attr_ field_ ->
                                  ...
                                  {-# LINE 4022 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule480 #-}
   {-# LINE 1058 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule480 = \ _mbTp ->
                                  {-# LINE 1058 "src-ag/ExecutionPlan2Caml.ag" #-}
                                  isJust _mbTp
                                  {-# LINE 4028 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule481 #-}
   {-# LINE 1059 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule481 = \ ((_lhsIoptions) :: Options) ->
                                  {-# LINE 1059 "src-ag/ExecutionPlan2Caml.ag" #-}
                                  typeSigs _lhsIoptions
                                  {-# LINE 4034 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule482 #-}
   ...
   rule482 = \ _hasTp _mbTp _o_sigs _var ->
                                  ...
                                  {-# LINE 4040 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule483 #-}
   ...
   rule483 = \ ((_patIisUnderscore) :: Bool) ((_patIsem_lhs) ::  PP_Doc ) _var ->
                                  ...
                                  {-# LINE 4048 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule484 #-}
   {-# LINE 1077 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule484 = \  (_ :: ()) ->
                                    {-# LINE 1077 "src-ag/ExecutionPlan2Caml.ag" #-}
                                    False
                                    {-# LINE 4054 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule485 #-}
   ...
   rule485 = \ ((_lhsIoptions) :: Options) ((_patIattrs) :: Set String) attr_ field_ ->
                    ...
                    {-# LINE 4060 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule486 #-}
   ...
   rule486 = \ ((_lhsIlocalAttrTypes) :: Map Identifier Type) ((_lhsIsynmap) :: Attributes) attr_ field_ ->
                    ...
                    {-# LINE 4070 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule487 #-}
   ...
   rule487 = \ ((_lhsIoptions) :: Options) _mbTp ((_patIattrTypes) :: PP_Doc) attr_ field_ ->
                    ...
                    >-< _patIattrTypes
                    {-# LINE 4077 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule488 #-}
...
sem_Pattern_Irrefutable arg_pat_ = T_Pattern (return st41) where
   ...
   rule497 = \ ((_patIsem_lhs) ::  PP_Doc ) ->
                                  ...
                                  {-# LINE 4142 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule498 #-}
...
sem_Pattern_Underscore arg_pos_ = T_Pattern (return st41) where
   ...
   rule511 = \  (_ :: ()) ->
                                  {-# LINE 1067 "src-ag/ExecutionPlan2Caml.ag" #-}
                                  text "_"
                                  {-# LINE 4210 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule512 #-}
   {-# LINE 1078 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule512 = \  (_ :: ()) ->
                                    {-# LINE 1078 "src-ag/ExecutionPlan2Caml.ag" #-}
                                    True
                                    {-# LINE 4216 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule513 #-}
   rule513 = \  (_ :: ()) ->
     empty
   {-# INLINE rule514 #-}
...
sem_Visit_Visit arg_ident_ arg_from_ arg_to_ arg_inh_ arg_syn_ arg_steps_ arg_kind_ = T_Visit (return st47) where
   ...
   rule549 = \ ((_lhsInextVisits) :: Map StateIdentifier StateCtx) to_ ->
                          ...
                          {-# LINE 4548 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule550 #-}
   {-# LINE 546 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule550 = \ ((_lhsIparams) :: [Identifier]) ->
                    {-# LINE 546 "src-ag/ExecutionPlan2Caml.ag" #-}
                    ppTypeParams _lhsIparams
                    {-# LINE 4554 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule551 #-}
   ...
   rule552 = \ _contpart _inhpart ((_lhsInt) :: NontermIdent) _nameCaller_visit _nameTIn_visit _nameTOut_visit _synpart _t_c_params _t_params ident_ ->
                    ...
                    {-# LINE 4571 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule553 #-}
   ...
   rule553 = \ ((_lhsInt) :: NontermIdent) _nameNextState _nextVisitInfo _t_params ident_ ->
                   ...
                   {-# LINE 4579 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule554 #-}
   ...
   rule554 = \ ((_lhsIinhmap) :: Attributes) _ppTypeList inh_ ->
                    ...
                    {-# LINE 4585 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule555 #-}
   ...
   rule555 = \ ((_lhsIsynmap) :: Attributes) _ppTypeList syn_ ->
                    ...
                    {-# LINE 4591 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule556 #-}
   ...
   rule556 = \ ((_lhsInt) :: NontermIdent) ident_ ->
                     ...
                     {-# LINE 4598 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule557 #-}
   ...
   rule560 = \ ((_lhsIallintramap) :: Map StateIdentifier (Map String (Maybe NonLocalAttr))) to_ ->
                     ...
                     {-# LINE 4627 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule561 #-}
   {-# LINE 809 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule561 = \ _nextArgsMp ->
                     {-# LINE 809 "src-ag/ExecutionPlan2Caml.ag" #-}
                     ppSpaced $ Map.keys $ _nextArgsMp
                     {-# LINE 4633 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule562 #-}
   ...
   rule562 = \ ((_lhsIoptions) :: Options) _nextArgs _nextArgsMp to_ ->
                     ...
                     {-# LINE 4639 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule563 #-}
   ...
   rule563 = \ ((_lhsInt) :: NontermIdent) ((_lhsIoptions) :: Options) _nextStRefExp ident_ syn_ ->
                    ...
                    ppRecordVal
                      ...
                      ++ [ _nextStRefExp     ])
                    {-# LINE 4647 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule564 #-}
   ...
   rule564 = \ ((_lhsInt) :: NontermIdent) _nextStExp _nextVisitInfo ident_ ->
         ...
         {-# LINE 4656 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule565 #-}
   {-# LINE 832 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule565 = \ kind_ ->
                                  {-# LINE 832 "src-ag/ExecutionPlan2Caml.ag" #-}
                                  kind_
                                  {-# LINE 4662 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule566 #-}
   {-# LINE 884 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule566 = \  (_ :: ()) ->
                                     {-# LINE 884 "src-ag/ExecutionPlan2Caml.ag" #-}
                                     0
                                     {-# LINE 4668 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule567 #-}
   {-# LINE 891 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule567 = \  (_ :: ()) ->
                                              {-# LINE 891 "src-ag/ExecutionPlan2Caml.ag" #-}
                                              0
                                              {-# LINE 4674 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule568 #-}
   {-# LINE 908 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule568 = \  (_ :: ()) ->
                                           {-# LINE 908 "src-ag/ExecutionPlan2Caml.ag" #-}
                                           False
                                           {-# LINE 4680 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule569 #-}
   ...
   rule571 = \ ((_lhsInt) :: NontermIdent) ((_lhsIoptions) :: Options) _nameTOut_visit _nextVisitInfo _o_sigs _prevVisitInfo from_ ident_ inh_ kind_ syn_ to_ ->
        ...
        {-# LINE 4725 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule572 #-}
   ...
   rule581 = \ _inhVarNms ((_stepsIdefs) :: Set String) kind_ ->
                        ...
                        case kind_ of
                          ...
                          _               -> Set.empty
                        {-# LINE 4789 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule582 #-}
...
sem_VisitStep_Sem arg_name_ = T_VisitStep (return st50) where
   ...
   rule600 = \ ((_lhsImrules) :: Map Identifier (VisitKind ->  Either Error PP_Doc)) name_ ->
                               ...
                               {-# LINE 4926 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule601 #-}
   ...
   rule605 = \ ((_lhsIruledefs) :: Map Identifier (Set String)) name_ ->
                            ...
                            {-# LINE 4958 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule606 #-}
   ...
   rule606 = \ ((_lhsIruleuses) :: Map Identifier (Map String (Maybe NonLocalAttr))) name_ ->
                            ...
                            {-# LINE 4964 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule607 #-}
   rule607 = \  (_ :: ()) ->
     Set.empty
   {-# INLINE rule608 #-}
...
sem_VisitStep_ChildVisit arg_child_ _ arg_visit_ = T_VisitStep (return st50) where
   ...
   rule612 = \ ((_lhsIallchildvisit) :: Map VisitIdentifier (Identifier -> Type -> VisitKind -> PP_Doc -> Either Error PP_Doc)) visit_ ->
                                ...
                                {-# LINE 5019 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule613 #-}
   ...
   rule613 = \ ((_lhsIchildTypes) :: Map Identifier Type) child_ ->
                                 ...
                                 {-# LINE 5025 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule614 #-}
   ...
   rule614 = \ _childType ((_lhsIfollow) :: PP_Doc) ((_lhsIkind) :: VisitKind) _visitItf child_ ->
                                               ...
                                               {-# LINE 5033 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule615 #-}
   ...
   rule615 = \ ((_lhsIavisitdefs) :: Map VisitIdentifier (Set Identifier)) ((_lhsIoptions) :: Options) _to child_ visit_ ->
                            ...
                            {-# LINE 5039 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule616 #-}
   ...
   rule616 = \ _from ((_lhsIavisituses) :: Map VisitIdentifier (Set Identifier)) ((_lhsIoptions) :: Options) child_ visit_ ->
                            ...
                            {-# LINE 5047 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule617 #-}
   ...
   rule617 = \ ((_lhsIallFromToStates) :: Map VisitIdentifier (Int,Int)) visit_ ->
                         ...
                         {-# LINE 5053 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule618 #-}
   rule618 = \  (_ :: ()) ->
     Set.empty
   {-# INLINE rule619 #-}
...
sem_VisitStep_PureGroup arg_steps_ arg_ordered_ = T_VisitStep (return st50) where
   ...
   rule625 = \ ordered_ ->
                 {-# LINE 836 "src-ag/ExecutionPlan2Caml.ag" #-}
                 VisitPure ordered_
                 {-# LINE 5131 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule626 #-}
   ...
   rule626 = \ ((_stepsIdefs) :: Set String) ((_stepsIlazyIntras) :: Set String) ordered_ ->
                     ...
                     {-# LINE 5139 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule627 #-}
...
sem_VisitStep_Sim arg_steps_ = T_VisitStep (return st50) where
   ...
   rule653 = \  (_ :: ()) ->
                                     {-# LINE 885 "src-ag/ExecutionPlan2Caml.ag" #-}
                                     0
                                     {-# LINE 5275 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule654 #-}
   {-# LINE 886 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule654 = \ ((_lhsIindex) :: Int) ->
                                     {-# LINE 886 "src-ag/ExecutionPlan2Caml.ag" #-}
                                     _lhsIindex
                                     {-# LINE 5281 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule655 #-}
   ...
   rule655 = \ ((_lhsIprevMaxSimRefs) :: Int) ((_stepsIindex) :: Int) _useParallel ->
                         ...
                         {-# LINE 5289 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule656 #-}
   ...
   rule656 = \ ((_lhsIoptions) :: Options) ((_stepsIsize) :: Int) ->
                                         ...
                                         {-# LINE 5295 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule657 #-}
...
sem_VisitStep_ChildIntro arg_child_ = T_VisitStep (return st50) where
   ...
   rule682 = \ ((_lhsIchildintros) :: Map Identifier (VisitKind -> Either Error (PP_Doc, Set String, Map String (Maybe NonLocalAttr)))) child_ ->
                                 ...
                                 {-# LINE 5407 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule683 #-}
   ...
   rule683 = \ _attachItf ((_lhsIkind) :: VisitKind) ->
                     ...
                     {-# LINE 5415 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule684 #-}
   {-# LINE 859 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule684 = \ ((_lhsIfollow) :: PP_Doc) _sem_steps ->
                                 {-# LINE 859 "src-ag/ExecutionPlan2Caml.ag" #-}
                                 _sem_steps     >-< _lhsIfollow
                                 {-# LINE 5421 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule685 #-}
   rule685 = \  (_ :: ()) ->
     Set.empty
   {-# INLINE rule686 #-}
...
sem_VisitSteps_Nil  = T_VisitSteps (return st53) where
   ...
   rule739 = \ ((_lhsIfollow) :: PP_Doc) ->
                            {-# LINE 846 "src-ag/ExecutionPlan2Caml.ag" #-}
                            _lhsIfollow
                            {-# LINE 5751 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule740 #-}
   {-# LINE 875 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule740 = \  (_ :: ()) ->
                      {-# LINE 875 "src-ag/ExecutionPlan2Caml.ag" #-}
                      0
                      {-# LINE 5757 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule741 #-}
   {-# LINE 901 "src-ag/ExecutionPlan2Caml.ag" #-}
   rule741 = \  (_ :: ()) ->
                         {-# LINE 901 "src-ag/ExecutionPlan2Caml.ag" #-}
                         True
                         {-# LINE 5763 "src-generated/ExecutionPlan2Caml.hs" #-}
   {-# INLINE rule742 #-}
   rule742 = \  (_ :: ()) ->
     Set.empty
   {-# INLINE rule743 #-}
